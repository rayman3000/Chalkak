...
public class RatingBarView extends LinearLayout {
    ...
    public RatingBarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, bulgogi1216.gmail.photogenic.R.styleable.RatingBarView);
        starImageSize = a.getDimension(bulgogi1216.gmail.photogenic.R.styleable.RatingBarView_starImageSize, 20);
        starCount = a.getInteger(bulgogi1216.gmail.photogenic.R.styleable.RatingBarView_starCount, 5);
        starEmptyDrawable = a.getDrawable(bulgogi1216.gmail.photogenic.R.styleable.RatingBarView_starEmpty);
        starFillDrawable = a.getDrawable(bulgogi1216.gmail.photogenic.R.styleable.RatingBarView_starFill);
